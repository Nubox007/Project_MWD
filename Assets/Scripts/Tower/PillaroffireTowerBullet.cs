...
{
    public class PillaroffireTowerBullet : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            // Check if the projectile will collide with a "Monster" tagged object
            if (Physics.SphereCast(transform.position, radius, direction, out hit, detectionDistance) && hit.collider.CompareTag("Monster"))
            {
                ...
                PillaroffireTowerBulletE projectileScript = impactP.GetComponent<PillaroffireTowerBulletE>();
            ...
            {
                // If the projectile doesn't collide with a "Monster" tagged object after 3 seconds, destroy it
